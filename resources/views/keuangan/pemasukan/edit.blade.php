...
<div class="max-w-2xl mx-auto">
    <x-card>
        ...
        <form action="{{ route('keuangan.update', $keuangan) }}" method="POST" class="space-y-4">
            ...
            <div class="flex justify-end gap-2 pt-4"><a href="{{ route('keuangan.pemasukan.index') }}" class="px-4 py-2 border rounded-md text-sm">Batal</a><button type="submit" class="px-6 py-2 bg-green-600 text-white rounded-md text-sm font-semibold">Update</button></div>
        </form>
    </x-card>
</div>
@endsection
